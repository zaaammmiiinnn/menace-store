...
const LOOKS: LookItem[] = [
  ...
  },
  {
    ...
    slug: "loud-menance",
    productName: "The Loud Menance Tee",
    price: 1499,
    colorName: "Acid Green",
    colorHex: "#C6FF00",
    image: "/images/products/loud-menance-1.jpg",
    hotspots: [
  ...
  },
  {
    ...
    productName: "The Midnight Menance Tee",
    price: 1399,
    colorName: "Pitch Black",
    colorHex: "#000000",
    image: "/images/products/midnight-menance-1.jpg",
    hotspots: [
  ...
  },
  {
    ...
    slug: "public-menance",
    productName: "The Acid Menance Tee",
    price: 1499,
    colorName: "Acid Green",
    colorHex: "#C6FF00",
    image: "/images/products/acid-menance-1.jpg",
    hotspots: [
      { x: 50, y: 45, label: "High-Visibility Cyber Typography", item: "The Acid Menance Tee" },
