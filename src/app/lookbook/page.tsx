...
const LOOKS: LookItem[] = [
  {
    ...
    colorHex: "#E8E0D0",
    hotspots: [
      { x: 50, y: 45, label: "280 GSM Waffle Knit", item: "The Quiet Menace Tee" },
  ...
  },
  {
    ...
    slug: "sunday-menace",
    productName: "The Sunday Menace Tee",
    price: 1299,
    colorName: "Washed Black",
    colorHex: "#1A1A1A",
    hotspots: [
      { x: 50, y: 44, label: "Vintage Pre-Shrunk Finish", item: "The Sunday Menace Tee" },
    ],
  },
];
